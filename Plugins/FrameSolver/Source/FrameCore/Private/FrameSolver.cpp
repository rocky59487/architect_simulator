...
// fpMix / fpBits / modelFingerprint moved to ModelHash.h so the HP-FEM opt-in lane
// (HpSolver.cpp) shares the exact same reuse-validity hash (logic byte-identical).
