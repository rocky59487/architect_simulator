...
namespace
{
    // Member-axis orthonormal frame, identical convention to v3.3 stress-field actor.
                                                    ...
                                                    const FFrameMemberGeometry& Geom)
{
    ...
    // 11-ring extrusion mirrors v3.3 stress-field actor count so PMC vertex / index totals
    // are predictable and testable from the gate's $ExpectedUeTests row.
