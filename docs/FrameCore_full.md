<!--
  完整技術參考(封存)/ Full technical reference (archived).
  保留 FrameCore 完整能力地圖、誠實範圍邊界、逐版發行歷史與驗證證據鏈。
  策展版、適合快速上手的門面 README → ../Plugins/FrameSolver/README.md
  專案總門面 → ../README.md
  ---
  Exhaustive engineering reference. Curated get-started README:
  ../Plugins/FrameSolver/README.md · Project landing: ../README.md
-->
