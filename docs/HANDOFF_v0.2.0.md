...
|---|---|---|---|
| `Source/ArchSim/Public/Characters/ArchSimCharacter.h` | +69 (new + AS-03a/b/c extensions) | Production | AS-03a/b/c |
| `Source/ArchSim/Private/Characters/ArchSimCharacter.cpp` | +186 | Production | AS-03a/b/c |
